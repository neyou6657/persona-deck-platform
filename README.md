...
- [`deno-relay`](deno-relay): Deno control plane for auth, persona routing, sessions, runs, and agent-facing knowledge APIs
...
- [`android-client`](android-client): Android client that talks to Deno, syncs personas, and handles persona chat UX
...
- [`deno-relay/README.md`](deno-relay/README.md) will track PostgreSQL, admin auth, and knowledge routing
- [`hf-space-agent/README.md`](hf-space-agent/README.md) tracks worker runtime, startup sync, and relay wiring
- [`android-client/`](android-client) is being reshaped into a server-backed client rather than a fake local demo
